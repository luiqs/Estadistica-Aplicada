...
A cada estudiante se le asigno una base de datos especifica. Cada base de datos representa una estación de monitoreo de calidad del aire en la ciudad de Beijing. En la siguiente tabla puede ver que base de datos le ha tocado a cada uno:

```{r include=FALSE}
library(tidyverse)
Tabla1 <- tibble(
  Nombre = c("ALIAGA ARROYO", "ATOCHE CORONEL", "BALTAZAR HINOSTROZA", "COLLANTES ALARCON", "DE LA CRUZ PEÑA", 
             "ESPINOZA ROJAS", "JIMENEZ RODRIGUEZ", "PORZOLIS MORAN", "RAMIREZ ORDAYA", "LUIS ROCA","LUIS ROCA"),
  Estación = c("Aotizhongxin", "Changping", "Dingling", "Dongsi", "Guanyuan", "Gucheng", "Huairou", "Nongzhanguan","Shunyi", "Tiantan","Wanliu"),
  Data = c("https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Aotizhongxin.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Changping.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Dingling.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Dongsi.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Guanyuan.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Gucheng.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Huairou.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Nongzhanguan.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Shunyi.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Tiantan.csv", "https://raw.githubusercontent.com/luiqs/Estadistica-Aplicada/main/Beijing%20-%20Air%20Quality%20measures/Wanliu.csv")
)
```
...
+ Para obtener la data solo necesitan convocar a la función "read.csv()" y pegar dentro del paréntesis la dirección github según la base de datos que le haya tocado. Recuerde que esta base de datos debe de asignarla a un nombre de su elección para poder trabajar con ella. 
...
+ Son 6 preguntas, cada pregunta sera considerada con un puntaje final de 4 puntos. 5 preguntas serán consideradas para su evaluación final, aquella con la mínima nota sera eliminada.
...
+ No olvide eliminar los NA de las variables de estudio (pueda ser que le salga error si es que no limpia su base de datos o tiene presente las implicancias de los NA).
