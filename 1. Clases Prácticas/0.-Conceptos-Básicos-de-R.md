...
automáticamente, tendremos que seleccionarlo e ir a archivo -\> Guardar
como (colocamos el nombre de nuestro archivo y la terminación .R).
Cuando guardemos, este nuevo archivo aparecerá en nuestra pestaña de
Archivos donde antes solo estaba el proyecto.
...
-   as_tibble() : donde el argumento que colocaremos será igual al
...
utilizaremos los símbolos “\<-”. Entonces seria de la siguiente manera:
...
“Vector_Ejemplo” lo haremos de la siguiente manera:
...
variable que crearemos llamada Seleccion_variable1
...
archivo + su extensión utilizando la función “read_csv()” del paquete
readr.
