...
5.  summarise() -&gt; colapsar varios valores para dar un resumen de los
    mismos
6.  group\_by() -&gt; opera la función a la que acompaña grupo a grupo
...
```
    ...
    ##  7 Palpat~    170  75   grey        pale       yellow          82   male  mascu~
    ##  8 Boba F~    183  78.2 black       fair       brown           31.5 male  mascu~
    ##  9 Lando ~    177  79   black       dark       brown           31   male  mascu~
    ## 10 Lobot      175  79   none        light      blue            37   male  mascu~
    ## 11 Nien N~    160  68   none        grey       black           NA   male  mascu~
    ## 12 Jar Ja~    196  66   none        orange     orange          52   male  mascu~
    ## 13 Ben Qu~    163  65   none        grey, gre~ orange          NA   male  mascu~
    ## 14 Jango ~    183  79   black       tan        brown           66   male  mascu~
...
```
    ...
    ##  3 Gasga~    122    NA none       white, blue  black             NA male  mascu~
    ##  4 Kit F~    196    87 none       green        black             NA male  mascu~
    ##  5 Plo K~    188    80 none       orange       black             22 male  mascu~
    ##  6 Lama ~    229    88 none       grey         black             NA male  mascu~
    ##  7 Taun ~    213    NA none       grey         black             NA fema~ femin~
    ##  8 Shaak~    178    57 none       red, blue, ~ black             NA fema~ femin~
...
```
    ...
    ##  5 Gasga~    122    NA none       white, blue  black             NA male  mascu~
    ##  6 Kit F~    196    87 none       green        black             NA male  mascu~
    ##  7 Plo K~    188    80 none       orange       black             22 male  mascu~
...
“drop\_na()” del paquete tidyr. Usualmente, lo podemos utilizar con el
operador pipie (%&gt;%):
...
Nos enfocaremos en la función **pivot\_longer()** del paquete tidyr.
...
pivot\_longer() es utilizada con 3 argumentos. El primer argumento
“names\_to=” nos indica a donde serán distribuidas todas las columnas
que vamos a seleccionar (está decisión se tiene tomar con anticipación,
acuerdense que dijimos que País permaneceria y las otras estarian
indicando lo mismo). El segundo argumento “values\_to=” nos indica como
...
Al igual que la función “pivot\_longer()” la función “pivot\_wider()”
del paquete tidyr realiza el proceso inverso. El cuál es también uti en
...
EXTRA: Averiguar para que serviria el argumento “**names\_types=**”
dentro de la función **pivot\_longer()**.
...
-   Encuentre la mediana (de altura y el peso) de los personajes según
    su especie ( función median() ).
-   Encuentre el valor máximo y mínimo (de altura y el peso) de cada
    especie ( funciones max() y min() ).
