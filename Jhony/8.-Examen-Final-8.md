...
de calidad del agua (**Calidad.Agua**) para aquellas zonas cercanas,
lejos y muy lejos del bosque en estudio (**Cercania**). Asuman que la
normalidad y homogeneidad de varianzas se cumplen. **Nota:** Grafique,
...
indice de biodiversidad (**Biodiversidad**), en función a la cercania de
las ciudades a los bosques en el estudio. **Nota:** Grafique, explique,
...
relación a el número de habitantes (**Habitantes.Ciudad(miles)**) y la
...
**Biodiversidad** y la variable independiente
**Habitantes.Ciudad(miles)**. Realice todos los análisis aprendidos y
necesarios para encontrar el mejor modelo “posible” con las dos
variables propuestas. **Nota:** Grafique, explique, discuta e interprete
