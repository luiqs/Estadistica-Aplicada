...
de concentración de plomo en agua (**Plomo(mg/L)**) para aquellas zonas
cercanas, lejos y muy lejos del bosque en estudio (**Cercania**). Asuman
...
Utilizando un agrupamiento jerárquico, agrupe a las zonas del estudio
utilizando las variables: número de habitantes y calidad del agua.
