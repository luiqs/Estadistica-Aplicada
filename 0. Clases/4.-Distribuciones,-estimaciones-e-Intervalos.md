...
## 1.Paquete samplingbook, funciones para muestreo aleatorio simple:
...
# 2. Muestreo estratificado o por conglomerados: Aprendiendo a escribir funciones
...
## 2.1. Ejemplo: Funcion para un muestreo simple de una proporcion con poblacion infinita (o finita)
...
## 2.2 Funciones creadas por el Profesor LR (bajo construción…)

### 2.2.1 Para calcular el tamaño muestral de la media (sea poblacion finita o infinita)
...
![](4.-Distribuciones,-estimaciones-e-Intervalos_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
