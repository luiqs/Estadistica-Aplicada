...
El anova se basa en la construccion de un modelo. En este sentido, este
es el primer modelo del curso de estadistica aplicada que vamos a
utilizar. Para crear un modelo, debemos usar una funcion especifica de
ese modelo, para luego definir las variables de la ecuacion. Para crear
un modelo ANOVA, utilizamos la funcion *aov()*. Esta funcion, espera que
...
va a corresponder a una variable categorica (nominal, ordinal o
discreta), y la variable dependiente es aquella que estamos evaluando en
razon a su respuesta a la variable independiente. De esta manera, para
...
llamar al resumen (con funcion, **summary()**) del modelo que acabamos
de construir:
...
del contraste de hipotesis de la prueba ANOVA. …..

El diagrama de cajas (Box Plot) es tipicamente utilizado para gráficar
...
![](5.-Pruebas-de-hipotesis_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
el modelo ANOVA ya creado con la funcion *TukeyHSD()*.
...
![](5.-Pruebas-de-hipotesis_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
