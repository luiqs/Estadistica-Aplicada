...
Si gustan, tambien pueden basarse en otras paginas que tienen otra
...
otras maneras de dibujar el desafio.
...
**Desafió R en clase**: Si queremos algo mucho mas avanzado y
profesional para graficar el test de Tukey, utilizaremos en paquete
ggplot2, con la ayuda de la siguiente pagina
